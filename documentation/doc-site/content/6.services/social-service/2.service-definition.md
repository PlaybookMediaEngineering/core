...
- [social_service/v2/message.proto](#social_service_v2_message-proto)
    - [AuditLog](#social_service-v2-AuditLog)
    ...
    - [Role](#social_service-v2-Role)
    - [StripeSubscription](#social_service-v2-StripeSubscription)
    - [TeamProfile](#social_service-v2-TeamProfile)
    ...
    - [ActionType](#social_service-v2-ActionType)
    ...
    - [Outcome](#social_service-v2-Outcome)
    - [PermissionType](#social_service-v2-PermissionType)
    - [PublicationType](#social_service-v2-PublicationType)
    - [StripeSubscriptionStatus](#social_service-v2-StripeSubscriptionStatus)
...
- [social_service/v2/request_response.proto](#social_service_v2_request_response-proto)
    ...
    - [GetTeamResponse](#social_service-v2-GetTeamResponse)
    ...
    - [UpdateTeamMemberRoleRequest](#social_service-v2-UpdateTeamMemberRoleRequest)
    - [UpdateTeamMemberRoleResponse](#social_service-v2-UpdateTeamMemberRoleResponse)
...
<a name="social_service-v2-CreateTeamRequest"></a>
...
| ----- | ---- | ----- | ----------- |
| admin_user_id | [string](#string) |  | The user ID of the team administrator. This field is required. |
| team_name | [string](#string) |  | The name of the team. This field is required and should be unique. |
| description | [string](#string) |  | A brief description of the team, outlining its purpose and goals. This field is required. |
| tags | [string](#string) | repeated | A list of tags associated with the team, helping in categorization or searching. At least three tags are required. |
| admin_permission_type | [PermissionType](#social_service-v2-PermissionType) |  | The administrative permission type assigned to the team administrator. It should not be unspecified (0). |
...
<a name="social_service-v2-CreateTeamResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| team_id | [uint64](#uint64) |  | The ID of the newly created team. |
...
| email | [string](#string) |  | the email of the user | type: string |
| user_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the type of user being created | type: string business means a creator and user means a regular user |
...
<a name="social_service-v2-DeleteTeamRequest"></a>
...
| ----- | ---- | ----- | ----------- |
| admin_user_id | [string](#string) |  | The user ID of the team administrator. This field is required. |
| team_id | [uint64](#uint64) |  | The unique identifier of the team being deleted. This field is required. |
...
<a name="social_service-v2-DeleteTeamResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| success | [bool](#bool) |  | A boolean flag indicating if the team was successfully deleted. |
...
<a name="social_service-v2-EditTeamRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| admin_or_member_user_id | [string](#string) |  | The user ID of the team administrator. This field is required. |
| team_id | [uint64](#uint64) |  | The unique identifier of the team being updated. This field is required. |
| team | [TeamProfile](#social_service-v2-TeamProfile) |  | The team to update |
...
<a name="social_service-v2-EditTeamResponse"></a>
...
<a name="social_service-v2-GetTeamMemberRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| team_id | [uint64](#uint64) |  | The unique identifier of the team whose members are being requested. This field is required. |
| member_user_id | [string](#string) |  | The user ID of the member whose details are being requested. This field is required. |
...
<a name="social_service-v2-GetTeamMemberResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| member | [UserProfile](#social_service-v2-UserProfile) |  | The team member profile object containing details about the team member. |
...
<a name="social_service-v2-GetTeamRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| admin_or_member_user_id | [string](#string) |  | The user ID of the member or admin requesting the team details. This field is required. |
| team_id | [uint64](#uint64) |  | The unique identifier of the team whose details are being requested. This field is required. |
| include_members | [bool](#bool) |  | Optional flag to include detailed information about team members in the response. If true, the response will contain a list of team members and their roles. |
| include_publications | [bool](#bool) |  | Optional flag to include a list of publicatins or activities associated with the team in the response. If true, the response will contain detailed information about the team&#39;s projects or activities. |
| include_audit_logs | [bool](#bool) |  | Optional flag to include the team&#39;s audit log entries in the response. If true, the response will contain recent audit log entries for the team. |
...
<a name="social_service-v2-GetTeamResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| team | [TeamProfile](#social_service-v2-TeamProfile) |  | The team profile object containing details about the team. |
...
<a name="social_service-v2-PublishPostRequest"></a>

### PublishPostRequest
PublishPostRequest: Represents the request object invoked against the
social service to publish a post
...
<a name="social_service-v2-PublishPostResponse"></a>

### PublishPostResponse
PublishPostResponse: Represents the response object returned as a
response to the publish post request
...
<a name="social_service-v2-RemoveTeamMemberRequest"></a>
...
| ----- | ---- | ----- | ----------- |
| admin_user_id | [string](#string) |  | The user ID of the team administrator. This field is required. |
| team_id | [uint64](#uint64) |  | The unique identifier of the team from which the member is being removed. This field is required. |
| member_user_id | [string](#string) |  | The user ID of the member being removed from the team. This field is required. |
...
<a name="social_service-v2-RemoveTeamMemberResponse"></a>
...
<a name="social_service-v2-ReviewPostRequest"></a>

### ReviewPostRequest
ReviewPostRequest: Represents the request object invoked against the
social service to review a post
...
<a name="social_service-v2-ReviewPostResponse"></a>

### ReviewPostResponse
ReviewPostResponse: Represents the response object returned as a
response to the review post request
...
<a name="social_service-v2-SetPostInDraftModeRequest"></a>

### SetPostInDraftModeRequest
SetPostInDraftModeRequest: Represents the request object invoked against the
social service to set a post in draft mode
...
<a name="social_service-v2-SetPostInDraftModeResponse"></a>

### SetPostInDraftModeResponse
SetPostInDraftModeResponse: Represents the response object returned as a
response to the set post in draft mode request
...
<a name="social_service-v2-UpdateTeamMemberRoleRequest"></a>
...
| ----- | ---- | ----- | ----------- |
| admin_user_id | [string](#string) |  | The user ID of the team administrator. This field is required. |
| team_id | [uint64](#uint64) |  | The unique identifier of the team to which the member belongs. This field is required. |
| member_user_id | [string](#string) |  | The user ID of the member whose role is being updated. This field is required. |
| role | [Role](#social_service-v2-Role) |  | The new role assigned to the member. This field is required. |
...
<a name="social_service-v2-UpdateTeamMemberRoleResponse"></a>
...
| PublishPost | [PublishPostRequest](#social_service-v2-PublishPostRequest) | [PublishPostResponse](#social_service-v2-PublishPostResponse) |  |
| ReviewPost | [ReviewPostRequest](#social_service-v2-ReviewPostRequest) | [ReviewPostResponse](#social_service-v2-ReviewPostResponse) |  |
| SetPostInDraftMode | [SetPostInDraftModeRequest](#social_service-v2-SetPostInDraftModeRequest) | [SetPostInDraftModeResponse](#social_service-v2-SetPostInDraftModeResponse) |  |
| CreateTeam | [CreateTeamRequest](#social_service-v2-CreateTeamRequest) | [CreateTeamResponse](#social_service-v2-CreateTeamResponse) |  |
| DeleteTeam | [DeleteTeamRequest](#social_service-v2-DeleteTeamRequest) | [DeleteTeamResponse](#social_service-v2-DeleteTeamResponse) | Delete a Team |
| GetTeam | [GetTeamRequest](#social_service-v2-GetTeamRequest) | [GetTeamResponse](#social_service-v2-GetTeamResponse) |  |
| EditTeam | [EditTeamRequest](#social_service-v2-EditTeamRequest) | [EditTeamResponse](#social_service-v2-EditTeamResponse) |  |
| AddTeamMember | [AddTeamMemberRequest](#social_service-v2-AddTeamMemberRequest) | [AddTeamMemberResponse](#social_service-v2-AddTeamMemberResponse) |  |
| GetTeamMember | [GetTeamMemberRequest](#social_service-v2-GetTeamMemberRequest) | [GetTeamMemberResponse](#social_service-v2-GetTeamMemberResponse) | Get details of a specific TeamMember |
| RemoveTeamMember | [RemoveTeamMemberRequest](#social_service-v2-RemoveTeamMemberRequest) | [RemoveTeamMemberResponse](#social_service-v2-RemoveTeamMemberResponse) | Remove a member from a Team |
