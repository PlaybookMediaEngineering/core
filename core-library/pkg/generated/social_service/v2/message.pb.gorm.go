...
func (m *VirtualProfile) ToORM(ctx context.Context) (VirtualProfileORM, error) {
	...
	to.Email = m.Email
	to.StripeConnectAccountId = m.StripeConnectAccountId
...
type TeamProfileORM struct {
	Admin        *UserProfileORM `gorm:"foreignkey:AdminTeamProfileId;association_foreignkey:Id;preload:true"`
	AuditLogs    []*AuditLogORM  `gorm:"foreignkey:TeamProfileId;association_foreignkey:Id;preload:true"`
	CreatedAt    string
	Description  string
	FocusAreas   pq.StringArray `gorm:"type:text[]"`
	Id           uint64
	Members      []*UserProfileORM `gorm:"foreignkey:MembersTeamProfileId;association_foreignkey:Id;preload:true"`
	Publications []*PublicationORM `gorm:"foreignkey:TeamProfileId;association_foreignkey:Id;preload:true"`
	Roles        []*RoleORM        `gorm:"foreignkey:TeamProfileId;association_foreignkey:Id;preload:true"`
	Tags         pq.StringArray    `gorm:"type:text[]"`
	TeamName     string
}
...
func (m *TeamProfile) ToORM(ctx context.Context) (TeamProfileORM, error) {
	...
	if m.FocusAreas != nil {
		to.FocusAreas = make(pq.StringArray, len(m.FocusAreas))
		copy(to.FocusAreas, m.FocusAreas)
	}
	to.Description = m.Description
	to.CreatedAt = m.CreatedAt
	...
	for _, v := range m.AuditLogs {
		if v != nil {
			if tempAuditLogs, cErr := v.ToORM(ctx); cErr == nil {
				to.AuditLogs = append(to.AuditLogs, &tempAuditLogs)
			} else {
				return to, cErr
			}
		} else {
			to.AuditLogs = append(to.AuditLogs, nil)
		}
	}
...
func (m *TeamProfileORM) ToPB(ctx context.Context) (TeamProfile, error) {
	...
	for _, v := range m.AuditLogs {
		if v != nil {
			if tempAuditLogs, cErr := v.ToPB(ctx); cErr == nil {
				to.AuditLogs = append(to.AuditLogs, &tempAuditLogs)
			} else {
				return to, cErr
			}
...
type RoleORM struct {
	...
	Description   string
	Id            uint64
	Member        *UserProfileORM `gorm:"foreignkey:RoleId;association_foreignkey:Id;preload:true"`
	Name          string
	TeamProfileId *uint64
	UpdatedAt     string
}
...
func (m *Role) ToORM(ctx context.Context) (RoleORM, error) {
	...
	if m.Member != nil {
		tempMember, err := m.Member.ToORM(ctx)
		if err != nil {
			return to, err
		}
		to.Member = &tempMember
	}
	to.CreatedAt = m.CreatedAt
...
func (m *RoleORM) ToPB(ctx context.Context) (Role, error) {
	...
	// Repeated type enum is not an ORMable message type
	if m.Member != nil {
		tempMember, err := m.Member.ToPB(ctx)
		if err != nil {
			return to, err
		}
		to.Member = &tempMember
...
func (m *AuditLog) ToORM(ctx context.Context) (AuditLogORM, error) {
	...
	to.Description = m.Description
	to.ActionType = ActionType_name[int32(m.ActionType)]
	to.IpAddress = m.IpAddress
	to.Outcome = Outcome_name[int32(m.Outcome)]
	to.AffectedEntityType = m.AffectedEntityType
	to.AffectedEntityId = m.AffectedEntityId
...
func (m *AuditLogORM) ToPB(ctx context.Context) (AuditLog, error) {
	...
	to.Timestamp = m.Timestamp
	to.Description = m.Description
	to.ActionType = ActionType(ActionType_value[m.ActionType])
	to.IpAddress = m.IpAddress
	to.Outcome = Outcome(Outcome_value[m.Outcome])
	to.AffectedEntityType = m.AffectedEntityType
	to.AffectedEntityId = m.AffectedEntityId
...
func DefaultStrictUpdateVirtualProfile(ctx context.Context, in *VirtualProfile, db *gorm.DB) (*VirtualProfile, error) {
	...
	*filterCommunities.VirtualProfileId = ormObj.Id
	...
	filterStripeSubscriptions.VirtualProfileId = new(uint64)
	*filterStripeSubscriptions.VirtualProfileId = ormObj.Id
...
func DefaultApplyFieldMaskVirtualProfile(ctx context.Context, patchee *VirtualProfile, patcher *VirtualProfile, updateMask *field_mask.FieldMask, prefix string, db *gorm.DB) (*VirtualProfile, error) {
	...
	for i, f := range updateMask.Paths {
		...
		if f == prefix+"StripeConnectAccountId" {
			patchee.StripeConnectAccountId = patcher.StripeConnectAccountId
			continue
		}
	}
	if err != nil {
...
func DefaultCreateTeamProfile(ctx context.Context, in *TeamProfile, db *gorm.DB) (*TeamProfile, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
...
func DefaultReadTeamProfile(ctx context.Context, in *TeamProfile, db *gorm.DB) (*TeamProfile, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &TeamProfileORM{}); err != nil {
		return nil, err
	}
...
func DefaultDeleteTeamProfile(ctx context.Context, in *TeamProfile, db *gorm.DB) error {
	if in == nil {
		return errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
...
func DefaultDeleteTeamProfileSet(ctx context.Context, in []*TeamProfile, db *gorm.DB) error {
	if in == nil {
		return errors.NilArgumentError
	}
	var err error
...
type TeamProfileORMWithBeforeDeleteSet interface {
	BeforeDeleteSet(context.Context, []*TeamProfile, *gorm.DB) (*gorm.DB, error)
}
type TeamProfileORMWithAfterDeleteSet interface {
	AfterDeleteSet(context.Context, []*TeamProfile, *gorm.DB) error
}

// DefaultStrictUpdateTeamProfile clears / replaces / appends first level 1:many children and then executes a gorm update call
func DefaultStrictUpdateTeamProfile(ctx context.Context, in *TeamProfile, db *gorm.DB) (*TeamProfile, error) {
	if in == nil {
	...
	filterAdmin.AdminTeamProfileId = new(uint64)
	*filterAdmin.AdminTeamProfileId = ormObj.Id
	if err = db.Where(filterAdmin).Delete(UserProfileORM{}).Error; err != nil {
		return nil, err
	}
	filterAuditLogs := AuditLogORM{}
	if ormObj.Id == 0 {
		return nil, errors.EmptyIdError
	}
	filterAuditLogs.TeamProfileId = new(uint64)
	*filterAuditLogs.TeamProfileId = ormObj.Id
	if err = db.Where(filterAuditLogs).Delete(AuditLogORM{}).Error; err != nil {
		return nil, err
	}
	filterMembers := UserProfileORM{}
	if ormObj.Id == 0 {
		return nil, errors.EmptyIdError
	}
	filterMembers.MembersTeamProfileId = new(uint64)
	*filterMembers.MembersTeamProfileId = ormObj.Id
	if err = db.Where(filterMembers).Delete(UserProfileORM{}).Error; err != nil {
		return nil, err
	}
	filterPublications := PublicationORM{}
	if ormObj.Id == 0 {
	...
	filterPublications.TeamProfileId = new(uint64)
	*filterPublications.TeamProfileId = ormObj.Id
	if err = db.Where(filterPublications).Delete(PublicationORM{}).Error; err != nil {
		return nil, err
	}
	filterRoles := RoleORM{}
	...
	filterRoles.TeamProfileId = new(uint64)
	*filterRoles.TeamProfileId = ormObj.Id
...
func DefaultPatchTeamProfile(ctx context.Context, in *TeamProfile, updateMask *field_mask.FieldMask, db *gorm.DB) (*TeamProfile, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
...
type TeamProfileWithBeforePatchRead interface {
	BeforePatchRead(context.Context, *TeamProfile, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type TeamProfileWithBeforePatchApplyFieldMask interface {
	BeforePatchApplyFieldMask(context.Context, *TeamProfile, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type TeamProfileWithBeforePatchSave interface {
	BeforePatchSave(context.Context, *TeamProfile, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type TeamProfileWithAfterPatchSave interface {
	AfterPatchSave(context.Context, *TeamProfile, *field_mask.FieldMask, *gorm.DB) error
}

// DefaultPatchSetTeamProfile executes a bulk gorm update call with patch behavior
func DefaultPatchSetTeamProfile(ctx context.Context, objects []*TeamProfile, updateMasks []*field_mask.FieldMask, db *gorm.DB) ([]*TeamProfile, error) {
	if len(objects) != len(updateMasks) {
		return nil, fmt.Errorf(errors.BadRepeatedFieldMaskTpl, len(updateMasks), len(objects))
	}
...
func DefaultApplyFieldMaskTeamProfile(ctx context.Context, patchee *TeamProfile, patcher *TeamProfile, updateMask *field_mask.FieldMask, prefix string, db *gorm.DB) (*TeamProfile, error) {
	if patcher == nil {
		return nil, nil
	} else if patchee == nil {
		return nil, errors.NilArgumentError
	...
	for i, f := range updateMask.Paths {
		...
		if f == prefix+"FocusAreas" {
			patchee.FocusAreas = patcher.FocusAreas
			continue
		}
		if f == prefix+"Description" {
			patchee.Description = patcher.Description
		...
		if f == prefix+"AuditLogs" {
			patchee.AuditLogs = patcher.AuditLogs
			continue
		}
	}
	if err != nil {
...
func DefaultListTeamProfile(ctx context.Context, db *gorm.DB) ([]*TeamProfile, error) {
	in := TeamProfile{}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	...
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &TeamProfileORM{}, &TeamProfile{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
type TeamProfileORMWithAfterListFind interface {
	AfterListFind(context.Context, *gorm.DB, *[]TeamProfileORM) error
}
...
func DefaultStrictUpdateRole(ctx context.Context, in *Role, db *gorm.DB) (*Role, error) {
	...
	filterMember := UserProfileORM{}
	if ormObj.Id == 0 {
		return nil, errors.EmptyIdError
	}
	filterMember.RoleId = new(uint64)
	*filterMember.RoleId = ormObj.Id
	if err = db.Where(filterMember).Delete(UserProfileORM{}).Error; err != nil {
		return nil, err
	}
...
func DefaultApplyFieldMaskRole(ctx context.Context, patchee *Role, patcher *Role, updateMask *field_mask.FieldMask, prefix string, db *gorm.DB) (*Role, error) {
	...
	for i, f := range updateMask.Paths {
		...
		if !updatedMember && strings.HasPrefix(f, prefix+"Member.") {
			updatedMember = true
			if patcher.Member == nil {
				patchee.Member = nil
				continue
			}
			if patchee.Member == nil {
				patchee.Member = &UserProfile{}
			}
			if o, err := DefaultApplyFieldMaskUserProfile(ctx, patchee.Member, patcher.Member, &field_mask.FieldMask{Paths: updateMask.Paths[i:]}, prefix+"Member.", db); err != nil {
				return nil, err
			} else {
				patchee.Member = o
			}
...
func DefaultCreateAuditLog(ctx context.Context, in *AuditLog, db *gorm.DB) (*AuditLog, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
...
func DefaultReadAuditLog(ctx context.Context, in *AuditLog, db *gorm.DB) (*AuditLog, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &AuditLogORM{}); err != nil {
		return nil, err
	}
...
func DefaultDeleteAuditLog(ctx context.Context, in *AuditLog, db *gorm.DB) error {
	if in == nil {
		return errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
...
func DefaultDeleteAuditLogSet(ctx context.Context, in []*AuditLog, db *gorm.DB) error {
	if in == nil {
		return errors.NilArgumentError
	}
	var err error
...
type AuditLogORMWithBeforeDeleteSet interface {
	BeforeDeleteSet(context.Context, []*AuditLog, *gorm.DB) (*gorm.DB, error)
}
type AuditLogORMWithAfterDeleteSet interface {
	AfterDeleteSet(context.Context, []*AuditLog, *gorm.DB) error
}

// DefaultStrictUpdateAuditLog clears / replaces / appends first level 1:many children and then executes a gorm update call
func DefaultStrictUpdateAuditLog(ctx context.Context, in *AuditLog, db *gorm.DB) (*AuditLog, error) {
	if in == nil {
...
func DefaultPatchAuditLog(ctx context.Context, in *AuditLog, updateMask *field_mask.FieldMask, db *gorm.DB) (*AuditLog, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	var pbObj AuditLog
...
type AuditLogWithBeforePatchRead interface {
	BeforePatchRead(context.Context, *AuditLog, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type AuditLogWithBeforePatchApplyFieldMask interface {
	BeforePatchApplyFieldMask(context.Context, *AuditLog, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type AuditLogWithBeforePatchSave interface {
	BeforePatchSave(context.Context, *AuditLog, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type AuditLogWithAfterPatchSave interface {
	AfterPatchSave(context.Context, *AuditLog, *field_mask.FieldMask, *gorm.DB) error
}

// DefaultPatchSetAuditLog executes a bulk gorm update call with patch behavior
func DefaultPatchSetAuditLog(ctx context.Context, objects []*AuditLog, updateMasks []*field_mask.FieldMask, db *gorm.DB) ([]*AuditLog, error) {
	if len(objects) != len(updateMasks) {
		return nil, fmt.Errorf(errors.BadRepeatedFieldMaskTpl, len(updateMasks), len(objects))
	}
...
func DefaultApplyFieldMaskAuditLog(ctx context.Context, patchee *AuditLog, patcher *AuditLog, updateMask *field_mask.FieldMask, prefix string, db *gorm.DB) (*AuditLog, error) {
	if patcher == nil {
		return nil, nil
	} else if patchee == nil {
		return nil, errors.NilArgumentError
	...
	for _, f := range updateMask.Paths {
		...
		if f == prefix+"ActionType" {
			patchee.ActionType = patcher.ActionType
			continue
		}
		...
		if f == prefix+"Outcome" {
			patchee.Outcome = patcher.Outcome
			continue
		}
		if f == prefix+"AffectedEntityType" {
			patchee.AffectedEntityType = patcher.AffectedEntityType
			continue
		}
		if f == prefix+"AffectedEntityId" {
			patchee.AffectedEntityId = patcher.AffectedEntityId
			continue
		}
	}
	if err != nil {
...
func DefaultListAuditLog(ctx context.Context, db *gorm.DB) ([]*AuditLog, error) {
	in := AuditLog{}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	...
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &AuditLogORM{}, &AuditLog{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
type AuditLogORMWithAfterListFind interface {
	AfterListFind(context.Context, *gorm.DB, *[]AuditLogORM) error
}
